...
setwd(":/Edwisor/Car_Fare_Prediction_Project")
getwd()
...
#0.000    1.216    2.128   16.105    3.853 8677.252 
...
#     RMSE  Rsquared       MAE 
#0.2810553 0.4187878 0.2064114 

# For testing data 
print(postResample(pred = pred_test_DT, obs = test[,1]))
#     RMSE  Rsquared       MAE 
#0.2842566 0.4061057 0.2062801 
#-----------------Linear Regression-----------------------
...
#         RMSE  Rsquared       MAE 
#0.35960526 0.04851213 0.32093913  

# For testing data 
print(postResample(pred = pred_test_LR, obs = test[,1]))
#     RMSE  Rsquared       MAE 
#0.35931131 0.05158535 0.32037309   
...
#         RMSE  Rsquared       MAE 
#0.12402476 0.92113869 0.08824874  

# For testing data 
print(postResample(pred = pred_test_RF, obs = test[,1]))
#     RMSE  Rsquared       MAE 
#125.4015091   0.4777139  89.4558806
